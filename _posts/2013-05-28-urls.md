...
***Did you know?*** Tell us the location of your XML sitemap(s). An XML sitemap is a recommended best practice for search engine optimization. Visit [Sitemaps.org](http://www.sitemaps.org) for more details on how to create an XML sitemap. [Bing XML Sitemap Plugin](http://www.bing.com/webmaster/help/bing-sitemap-plugin-beta-f50bebf5) and [Google Sitemap Generator](https://code.google.com/p/googlesitemapgenerator/) are two open source tools that you can use to create XML sitemaps.

...
Watch our [Getting Started video](https://www.youtube.com/watch?v=p-y9T23ziEg) (4 mins){% external_link %}, read our [Site Launch Guide](https://search.gov/manual/site-launch-guide.html) or [view a recording](https://search.gov/manual/training.html) of Intro to Search.gov, a 1 hour overview of our system.  Our [Help Manual](https://search.gov/manual/index.html) is a section by section list of everything you'll see inside the Search Admin Center (the administrative dashboard you see after logging in).

Getting ready to launch? Before you go live with our service, we'll want to talk to you about your website and options for indexing your content. [Reach out to us](mailto:search@support.digitalgov.gov) and we can schedule a call.  You can also review our [go-live checklist](https://search.gov/manual/go-live.html) for tips and reminders.
...
* [All about XML Sitemaps](https://search.gov/manual/sitemaps.xml)
* [Help manual](https://search.gov/manual/)
...
* [Monthly release notes: the latest features, fixes, and focuses of the Search team](https://search.gov/tagged/release-notes/)

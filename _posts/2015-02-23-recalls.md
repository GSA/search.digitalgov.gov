...
The base URL is https://api.usa.gov/recalls/search.json?**parameters**

Sample API requests follow.

All recalls  
<https://api.usa.gov/recalls/search.json?>

All cribs  
<https://api.usa.gov/recalls/search.json?query=cribs>

All cribs that pose a choking hazard  
<https://api.usa.gov/recalls/search.json?query=cribs+choking>


All cribs that pose a choking hazard sorted by date  
<https://api.usa.gov/recalls/search.json?query=cribs+choking&sort=date>
...
Example (one agency): <https://api.usa.gov/recalls/search.json?organization=nhtsa>

Example (multiple agencies): <https://api.usa.gov/recalls/search.json?organization=fda+usda>

### start_date

Specifies the start date of the recall.

Example: <https://api.usa.gov/recalls/search.json?start_date=2012-01-01>

### end_date

Specifies the end date of the recall.

Example: <https://api.usa.gov/recalls/search.json?end_date=2012-12-31>

### page

Specifies the pagination of search results. Possible values are `1` to `20`.

Example: <https://api.usa.gov/recalls/search.json?page=3>

### per_page

Specifies the number of search results for each page. Possible values are `1` to `50`.

Example: <https://api.usa.gov/recalls/search.json?per_page=10>
...
Example: <https://api.usa.gov/recalls/search.json?sort=date>

### food_type 
Only for drug and food safety recalls. Possible values are `food` or `drug`.

Example: <https://api.usa.gov/recalls/search.json?food_type=drug>

### upc

Only for CPSC recalls. Specifies the UPC code when available. Not all products have UPC codes.

Example: <https://api.usa.gov/recalls/search.json?upc=042666601627>

### make, model, year, and code (only for NHTSA recalls)

* `make` specifies the make of the vehicle or equipment. Example: <https://api.usa.gov/recalls/search?make=winnebago>
* `model` specifies the model of the vehicle or equipment. Example: <https://api.usa.gov/recalls/search?model=ellipse>
* `year` specifies the year of the vehicle or equipment. Example: <https://api.usa.gov/recalls/search?year=2010>
* `code` specifies the NHTSA code. Possible values are `E`, `V` [for vehicles], `I`, `T`, `C`, or `X`. Example: <https://api.usa.gov/recalls/search?code=v>

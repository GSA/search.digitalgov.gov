...
Tell us the name of your website. Searchers see your site name on the results page, such as in your page title or [Best Bets](https://search.gov/manual/best-bets.html). We recommend using the plain language name for your agency or site, such as *Social Security Administration*.

## Homepage URL

Tell us the homepage URL of your website. Enter a fully qualified URL, including https://, https://www, etc. 

We use this homepage URL to (a) populate your primary [domain](https://search.gov/manual/domains.html) and (b) link the default logo on your results page to your homepage.
...
You chose your site's language (English, Spanish, or one of the other [69 supported languages](https://search.gov/manual/supported-languages.html) when you first [added your site](https://search.gov/manual/add-site.html). If you'd like to edit your site's language, [email us](mailto:search@support.digitalgov.gov).

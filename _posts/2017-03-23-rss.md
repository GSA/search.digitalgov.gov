...
**Module.** If you opted to show your RSS feed(s) as a module, searchers will see inline news results. It will highlight the three most recent, relevant results across all of your RSS feeds.

<img class="img-responsive" src="https://search.digitalgov.gov/img/RSS-Inline.png" alt="RSS Inline Module Example"></img>

**Facet.** If you opted to show your RSS feed(s) as a facet, searchers can narrow their results to see only RSS-based content by clicking on the facet.
...
<img class="img-responsive" src="https://search.digitalgov.gov/img/RSS-Facet.png" alt="RSS Facet Example with Results Count"></img>

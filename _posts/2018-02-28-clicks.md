...
Find it in the [Admin Center](https://search.usa.gov/sites/) > YourSite > Analytics > Clicks
...
* *Vertical* and *Modules*: The modules loaded in response to the query (Our [Module Codes](https://search.gov/manual/module-codes.html) tip provides a key of the codes and names.),

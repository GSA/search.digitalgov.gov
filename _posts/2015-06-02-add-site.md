...
If you select any other language, results will primarily include pages from the selected language. Display text will be in the selected language when localizations are available, and in English when they're not available.

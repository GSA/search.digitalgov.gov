...
The following terms of service ("Terms") govern the General Services Administration's (GSA) DigitalGov | Search website and services, including the content, documentation, code and related materials, are offered subject to your acceptance of the Terms as well as any relevant sections of the HowTo.gov [Site Policies](http://www.howto.gov/site-policies) (collectively, the "Agreement"). Access to or use of DigitalGov | Search services or its content constitutes acceptance to this Agreement. 
...
Customers using the Search Data API must display the [Web Results by Bing](http://download.microsoft.com/download/0/4/E/04E076D4-60B2-4D31-BCC7-C4805B558DBB/Bing%20product%20guidelines.pdf) [PDF] logo on 'web' and 'image' search results pages for attribution of web results. Customers using any of the other three indexes ('docs', 'news', and 'videonews') must display the DigitalGov | Search logo for attribution instead of the Bing logo.

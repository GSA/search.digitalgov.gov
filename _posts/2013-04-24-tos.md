...
The following terms of service ("Terms") govern the General Services Administration's (GSA) USASearch Program website and services, including the content, documentation, code and related materials, are offered subject to your acceptance of the Terms as well as any relevant sections of the HowTo.gov [Site Policies](http://www.howto.gov/site-policies) (collectively, the "Agreement"). Access to or use of USASearch services or its content constitutes acceptance to this Agreement. 
...
* When you use USASearch, we store information about searches on your site, including: the web page from which searchers accessed your search results, the date and time, the words searched for, items clicked on a page, and the browser and operating system used. We periodically delete our search logs.
...
* Once the data has been downloaded from USASearch, we can't vouch for the quality or timeliness of any analyses conducted with data retrieved.

## Citing Data

Customers using the Search Data API must display the [Web Results by Bing](http://download.microsoft.com/download/0/4/E/04E076D4-60B2-4D31-BCC7-C4805B558DBB/Bing%20product%20guidelines.pdf) [PDF] logo on 'web' and 'image' search results pages for attribution of web results. Customers using any of the other three indexes ('docs', 'news', and 'videonews') must display the USASearch logo for attribution instead of the Bing logo.

## Source Code

### Use of Open Source Software

USASearch uses open-source software and free or low cost, commercial application programming interfaces when it best meets the needs and mission of GSA.
...
You may not modify or falsely represent content accessed through USASearch yet still claim the source is USASearch.

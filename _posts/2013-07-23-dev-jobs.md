...
State and local government jobs are from cities, counties, and state agencies that use [NeoGov](http://www.neogov.com)&nbsp;<i class="icon-external-link"></i>, such [jobs with the the city of Boulder, Colorado](https://bouldercolorado.gov/jobs-and-volunteer).

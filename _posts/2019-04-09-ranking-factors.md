...
Documents with no date metadata at all are considered fresh and are not demoted. [Read more about the metadata we collect](https://search.gov/blog/metadata.html) and why it’s important to add metadata to your files.

...
Another section, Manage Display, makes it easier for you to select your [font and color scheme](/manual/font-colors.html), manage your [image assets](/manual/display-images.html), and turn other [display features](/manual/display-overview.html) on and off. Plus, you can now edit the 'News' label on the News Govbox.

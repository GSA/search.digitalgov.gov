...
***Top 10.*** You'll see a list, in frequency order, of top 10 most popular queries for your selected time period. 

***Top 10 by query.*** Enter any specific term or phrase into the Query search box. Re-generate the report to see the top 10 queries that contain that term or phrase and its stemmed equivalents. 

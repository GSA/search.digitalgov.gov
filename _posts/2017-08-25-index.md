...
**[Drupal Module](https://www.drupal.org/project/usasearch)**&mdash;Allows you to connect your Drupal website to your DigitalGov Search search configuration. The module also supports realtime indexing via DigitalGov Search's i14y content indexing API. Check out our [help docs here](/manual/drupal.html).

**[WordPress Plugin](https://github.com/GSA/sites-digitalgov-search)**&mdash;Starter code - contributions welcome! This plugin allows you to override the default WordPress search and connect your WordPress-powered website to your DigitalGov Search search configuration. 

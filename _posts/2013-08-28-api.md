...
We offer our search results as a hosted results page (using our [code snippets](/manual/code.html)) or as an [application programming interface](http://www.howto.gov/mobile/apis-in-government/api-basics) (API).

...
* You can now access https results from our [Search API](/manual/api.html).
...
* We now use a persistent file for your [header and footer CSS](/manual/header-footer.html) instead of generating it each time we load your results page.

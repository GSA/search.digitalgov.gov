...
* We sent Microsoft an updated list of federal, state, and local government URLs that aren't .gov or .mil so that searchers can get results from these sites on [USA.gov](http://www.usa.gov).

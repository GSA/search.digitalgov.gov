...
[Monthly reports](/sites/manual/monthly-report.html) and [query](/sites/manual/queries.html) and [click](/sites/manual/clicks.html) stats are also available through the new Analytics section. 

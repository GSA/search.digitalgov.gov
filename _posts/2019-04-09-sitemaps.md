...
redirect-from:
  - /blog/sitemaps.html
tags: sitemaps indexing help-manual
breadcrumbs:
  - label: "Home"
...
Read more about [robots.txt files](https://search.gov/manual/robotstxt.html), and take a look at ours: [https://search.gov/robots.txt](https://search.gov/robots.txt)

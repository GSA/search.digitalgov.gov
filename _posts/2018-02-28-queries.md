...
Find it in the [Admin Center](https://search.usa.gov/sites/) > YourSite > Analytics > Queries
...
* The modules loaded in response to the query (Our [Module Codes](https://search.gov/manual/module-codes.html) page provides a key of the codes and names.)
...
***Did you know?*** The [Monthly Report](https://search.gov/manual/monthly-reports.html) section gives a bird's-eye view of the number of queries and [clicks](https://search.gov/manual/clicks.html) on your site each month. The [Site Overview](https://search.gov/manual/site-overview.html) provides a snapshot of what has been happening on your site in the past day or so.

...
**[Search Results](/manual/api.html)**&mdash;Provides DigitalGov Search customers their search results in XML, JSON, or
JSON-P. This API is only available for use on official government websites.
[Sign up](https://search.usa.gov/signup) is required.
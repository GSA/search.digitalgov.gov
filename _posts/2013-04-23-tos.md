...
Customers using the Search Data API must display the [Web Results by Bing](http://download.microsoft.com/download/0/4/E/04E076D4-60B2-4D31-BCC7-C4805B558DBB/Bing%20product%20guidelines.pdf) [PDF] logo on 'web' and 'image' search results pages for attribution of web results. Customers using any of the other three indexes ('odie', 'news', and 'videonews') must display the USASearch logo for attribution instead of the Bing logo.

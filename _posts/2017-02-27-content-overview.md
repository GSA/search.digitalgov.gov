...
When you first [add a site](/manual/add-site.html), we pull the homepage you listed into your [domains](/manual/domains.html) list, and populate any social media accounts ([Flickr](/manual/flickr.html), [Twitter](/manual/twitter.html), and [YouTube](/manual/youtube.html)) and [RSS feeds](/manual/rss.html) that are linked from your homepage. Use the Discover option on this Content Overview page to automatically (re)discover the RSS and social media accounts on your site's homepage, or any other page you want to scan.

...
You can override your default Domains search scope by passing a hidden value for the domain in the search form code.
...
***Troubleshooting tip:*** If your website is secured with https, add 's' to your form action: `https://search.usa.gov/search` and also to your typeahead script: `https://search.usa.gov/javascripts/remote.loader.js`. If you don't specify these as https, searchers using Internet Explorer will receive a security message. 

***Did you know?*** We offer [DNS masking](/manual/cname.html), which allows you to show searchers your domain (instead of USA.gov). If you use a [domain mask](/manual/cname.html) for your search results page, to use https you will need to provide the SSL certificate for our infrastructure, including purchasing, renewal, and validation with certificate authorities.

***Did you know?*** If you're using Drupal, be sure to check out our [Drupal module](https://www.drupal.org/project/USASearch). If you're using WordPress on Sites.USA.gov, you can use our search and i14y indexing plug-ins. LINK TO PLUGINS?
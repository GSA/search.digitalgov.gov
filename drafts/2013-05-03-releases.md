...
* Searchers no longer see deep links for the first-listed search result.
...
* We updated the links in the header of the Admin Center and search results page to match our new website.
...
* We removed outdated, unnecessary code that allowed you to embed the search results page within an iFrame.
